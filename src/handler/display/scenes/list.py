...
class DisplayScenesListHandler(BaseHandler):
    ...
    def print_scene_data(self):
        ...
        if self.other_tasks:
            ...
            Util.print_title("Other Problem Display Scenes", stdio=self.stdio)
        ...
        if self.obproxy_tasks:
            ...
            Util.print_title("Obproxy Problem Display Scenes", stdio=self.stdio)
        ...
        if self.observer_tasks:
            ...
            Util.print_title("Observer Problem Display Scenes", stdio=self.stdio)
