...
class TestOBConnectionPool(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cluster_config = {"db_host": "127.0.0.1", "db_port": 2881, "tenant_sys": {"user": "root@sys", "password": "test_password"}}
    ...
    def test_pool_initialization(self, mock_connector):
        ...
        pool = OBConnectionPool(context=self.mock_context, cluster_config=self.cluster_config, max_size=5)
    ...
    def test_get_connection(self, mock_connector):
        ...
        pool = OBConnectionPool(context=self.mock_context, cluster_config=self.cluster_config, max_size=2)
