...
# Completion is now handled by obdiag's built-in 'complete' command.
# This file is kept for rollback purposes only.
# See rpm/init.sh for the new inline completion function.
#
# To rollback: Uncomment the code below and restore references in:
# - rpm/init.sh
# - rpm/oceanbase-diagnostic-tool.spec
# - Makefile

# Old static completion function (deprecated - kept for rollback)
# _obdiag_completion() {
